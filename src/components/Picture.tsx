...
import { FormLabel, BSGrid, BSCol, Input } from "@appquality/appquality-design-system";
...
export const Picture = ({ src, title, width = PictureDefaultProps.width, height = PictureDefaultProps.height, ...props }: PictureProps) => {
  const {
  ...
  return (
    <div {...props} className={classNames} ref={ref => connect(drag(ref as HTMLElement))}>
    ...
    <BSGrid>
      <BSCol size="col-12">
        ...
        <Input
          ...
          value={src}
          onChange={(e: string) => setProp((props: PictureProps) => props.src = e)}
        />
      </BSCol>
      <BSCol size="col-12">
        ...
        <Input
          value={title}
          onChange={(e: string) => setProp((props: PictureProps) => props.title = e)}
        />
      </BSCol>
      <BSCol size="col-12">
        ...
        <Input
          ...
          value={width}
          onChange={(e: string) => setProp((props: PictureProps) => props.width = e)}
        />
      </BSCol>
      <BSCol size="col-12">
        ...
        <Input
          ...
          value={height}
          onChange={(e: string) => setProp((props: PictureProps) => props.height = e)}
        />
      </BSCol>
      <BSCol size="col-12">
        <MarginSettings />
